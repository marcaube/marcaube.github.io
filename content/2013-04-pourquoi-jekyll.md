...
## Changement de cap
J'essaie d'utiliser [Github](https://github.com) de plus en plus, dans mon travail mais aussi pour mes projets personnels. Ça devient une sorte de porte-folio de mon code en plus de me mettre en contact avec d'autre développeurs.
