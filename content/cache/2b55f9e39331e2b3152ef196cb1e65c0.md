...
path = "cache/2b55f9e39331e2b3152ef196cb1e65c0.html"
template = "cache.html"
...
- [Make sure you actually need one](#make-sure-you-actually-need-one)
- [Cycle through like items](#cycle-through-like-items)
- [Make navigation obvious](#make-navigation-obvious)
- [Only load what you need](#only-load-what-you-need)
- [Suggest more content to users](#suggest-more-content-to-users)
- [Treat touch as an enhancement](#treat-touch-as-an-enhancement)
- [Provide gestural hints](#provide-gestural-hints)
